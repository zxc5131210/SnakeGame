...
class SampleTestLatin1(SampleOutputTestBase):
    MESSAGE = u'the message is 獺矇穩籀繳'.encode('latin-1')
...
class SampleTestUnicode(SampleOutputTestBase):
    ...
    def test_pass(self):
        u""" A test with Unicode (蝯曹�蝣�) docstring """
        pass
...
>test_3<
>fail<
AssertionError: the message is 獺矇穩籀繳

>test_4<
>error<
RuntimeError: the message is 獺矇穩籀繳
